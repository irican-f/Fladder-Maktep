...
String _$manualSubtitleOverrideHash() =>
    r'debf1ea8b80b2e8377d9b903d0c540d4ac62a527';
...
final manualSubtitleOverrideProvider =
    NotifierProvider<ManualSubtitleOverride, bool>.internal(
  ManualSubtitleOverride.new,
  name: r'manualSubtitleOverrideProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$manualSubtitleOverrideHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
