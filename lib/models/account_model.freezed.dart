...
mixin _$UserSettings implements DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    properties
      ...
      ..add(DiagnosticsProperty('preferOriginalAudio', preferOriginalAudio));
  }

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserSettings(skipForwardDuration: $skipForwardDuration, skipBackDuration: $skipBackDuration, preferOriginalAudio: $preferOriginalAudio)';
  }
}
...
abstract mixin class $UserSettingsCopyWith<$Res> {
  ...
  @useResult
  $Res call({Duration skipForwardDuration, Duration skipBackDuration, bool preferOriginalAudio});
}
...
class _$UserSettingsCopyWithImpl<$Res> implements $UserSettingsCopyWith<$Res> {
  ...
  $Res call({
    ...
    Object? preferOriginalAudio = null,
  }) {
    return _then(_self.copyWith(
      ...
      skipBackDuration: null == skipBackDuration
          ...
          : skipBackDuration // ignore: cast_nullable_to_non_nullable
              as Duration,
      preferOriginalAudio: null == preferOriginalAudio
          ? _self.preferOriginalAudio
          : preferOriginalAudio // ignore: cast_nullable_to_non_nullable
              as bool,
    ));
  }
}
...
extension UserSettingsPatterns on UserSettings {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(Duration skipForwardDuration, Duration skipBackDuration, bool preferOriginalAudio)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _UserSettings() when $default != null:
        return $default(_that.skipForwardDuration, _that.skipBackDuration, _that.preferOriginalAudio);
      case _:
        return orElse();
    }
  }
...
class _UserSettings with DiagnosticableTreeMixin implements UserSettings {
  _UserSettings(
      ...
      this.preferOriginalAudio = false});
  ...
  @override
  @JsonKey()
  final bool preferOriginalAudio;
