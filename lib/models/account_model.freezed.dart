...
mixin _$UserSettings implements DiagnosticableTreeMixin {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserSettings(skipForwardDuration: $skipForwardDuration, skipBackDuration: $skipBackDuration, preferOriginalAudio: $preferOriginalAudio, libraryFilters: $libraryFilters, filterSortOrder: $filterSortOrder, pDashboardSorting: $pDashboardSorting)';
  }
}
    ...
    switch (_that) {
      case _UserSettings() when $default != null:
        return $default(_that.skipForwardDuration, _that.skipBackDuration, _that.preferOriginalAudio,
            _that.libraryFilters, _that.filterSortOrder, _that.pDashboardSorting);
      case _:
        return orElse();
    }
  }
